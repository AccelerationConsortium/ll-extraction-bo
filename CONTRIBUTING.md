...
Welcome to `ll-extraction` contributor's guide.
...
If you experience bugs or general issues with `ll-extraction`, please have a look
...
You can help improve `ll-extraction` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ll-extraction` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ll-extraction`'s files. While this mechanism can
...
```
conda create -n ll-extraction python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ll-extraction.git
   cd ll-extraction
   ```
...
5. Install [pre-commit]:
   ...
   `ll-extraction` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ll-extraction
[issue tracker]: https://github.com/<USERNAME>/ll-extraction/issues
